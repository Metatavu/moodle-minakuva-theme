...
$string['frontpageheading'] = 'Etusivu';
$string['gpurl'] = 'Google+';
...
$string['contact_us'] = "Ota yhteyttä";
$string['followus'] = "Seuraa meitä";
$string['info'] = "Info";
$string['phone'] = "Puhelin";
$string['email'] = "Email";
$string['callus'] = "Puhelin";
$string['home'] = "Kotisivu";
